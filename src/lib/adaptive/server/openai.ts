...
export const questionSchema: JsonSchema = {
  ...
  required: ["id", "technology", "curriculumNodeId", "topic", "subtopic", "difficulty", "title", "scenario", "prompt", "schema", "sampleData", "expectedBehavior", "hiddenTests", "referenceSolution", "starterCode", "rubric", "skillDimensions", "fingerprint", "runtime"],
};
